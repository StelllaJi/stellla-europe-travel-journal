window.GAME_DATA = {
  ...
  memories: [
    ...
    { id: "lux-gare", city: "Luxembourg", title: "Gare：赶上与错过", text: "stellla曾经一个周末来了四趟gare，是旅途出发的美丽起点。", tags: ["train", "city"], art: "assets/generated/postcard-lux-gare-v1.png", photo: "assets/photos/lux-gare.jpg", status: "illustrated" },
    ...
    { id: "lux-alvisse", city: "Luxembourg", title: "回到 Alvisse", text: "回家回家！睡觉睡觉！开摆开摆！", tags: ["home", "nostalgia"], art: "assets/generated/home-room-v1.png", photo: "assets/photos/lux-alvisse.jpg", status: "illustrated" },
    ...
    { id: "lux-toro-oyster", city: "Luxembourg", title: "Toro 与生蚝", text: "好吃好吃好吃香香，我第一次见到这么大一坨金枪鱼", tags: ["rare", "friends"], art: "assets/generated/postcard-lux-toro-oyster-v1.png", photo: "assets/photos/lux-toro-oyster.jpg", status: "illustrated" },
    ...
    { id: "nancy-tree-playground", city: "Nancy", title: "钻进树桩", text: "在 Pépinière 的木头游乐场里，大人也可以暂时不太像大人，一起蠕动之", tags: ["surprise", "sunny"], art: "assets/generated/postcard-nancy-tree-playground-v2.png", photo: "assets/photos/nancy-tree-playground.jpg", status: "illustrated" },
    { id: "nancy-animal-space", city: "Nancy", title: "公园里的动物朋友", text: "每次见到小动物就会哈特软软，大家就在植物园里chill地亲人", tags: ["friends", "sunny"], art: "assets/generated/postcard-nancy-animals-v1.png", photo: "assets/photos/nancy-animal-space.jpg", status: "illustrated" },
    ...
    { id: "ams-bottle-return", city: "Amsterdam", title: "回收空瓶支线", text: "韩老师教我财富密码，没钱的时候可以去捡瓶子", tags: ["city", "surprise"], art: "assets/generated/postcard-ams-bottle-return-v1.png", photo: "assets/photos/ams-bottle-return.jpg", status: "illustrated" },
    { id: "ams-han-studio", city: "Amsterdam", title: "热得睡不着的 Studio", text: "韩老师的可爱小家，但是为什么我洗完澡就开始出汗。总之就是我喝多了。", tags: ["home", "friends", "conversation"], art: "assets/generated/postcard-ams-han-studio-v1.png", photo: "assets/photos/ams-han-studio.jpg", status: "illustrated", private: true },
