window.GAME_DATA = {
  ...
  memories: [
    { id: "lux-hamilius", city: "Luxembourg", title: "Hamilius 的电车声", text: "欢迎来到stellla的公司和活动区！在这里喝了很多很多杯酒，和同事聊了很多天。", tags: ["city", "train"], art: "assets/generated/postcard-lux-hamilius-v1.png", status: "illustrated" },
    { id: "lux-gare", city: "Luxembourg", title: "Gare：赶上与错过", text: "stellla曾经一个周末来了四趟gare，是出发的美丽起点。", tags: ["train", "city"], art: "assets/generated/postcard-lux-gare-v1.png", status: "illustrated" },
    { id: "lux-auchan", city: "Luxembourg", title: "欧尚采购事件", text: "欧尚的三文鱼，好吃😋", tags: ["home", "city"], art: "assets/generated/postcard-lux-auchan-v1.png", status: "illustrated" },
    { id: "lux-gelle-fra", city: "Luxembourg", title: "金色女神像下", text: "stellla又来遛弯了", tags: ["old-town", "sunny"], art: "assets/generated/postcard-lux-gelle-fra-v1.png", status: "illustrated" },
    { id: "lux-roma", city: "Luxembourg", title: "Restaurant Roma", text: "美丽的生日记忆！很好吃的饭和很可爱的蛋糕", tags: ["friends", "nostalgia"], art: "assets/generated/postcard-lux-roma-v1.png", status: "illustrated" },
    ...
    { id: "lux-dudelange", city: "Dudelange", title: "朋友家的门后", text: "第一次在这里遇见了朋友们，从此我的卢森堡生活开始幸福", tags: ["friends", "home"], art: "assets/generated/postcard-lux-dudelange-home-v1.png", status: "illustrated", private: true },
    { id: "lux-alvisse", city: "Luxembourg", title: "回到 Alvisse", text: "回家回家！", tags: ["home", "nostalgia"], art: "assets/generated/home-room-v1.png", status: "illustrated" },
    { id: "lux-ck-tennis", city: "Kockelscheuer", title: "室内球场", text: "网球真是太！好！玩！了！", tags: ["surprise", "friends"], art: "assets/generated/postcard-lux-ck-tennis-v1.png", status: "illustrated" },
    { id: "lux-onerepublic", city: "Luxembourg", title: "OneRepublic 之夜", text: "感谢卢森堡的纳税人们让我听到数星星！", tags: ["music", "celebration", "night"], art: "assets/generated/postcard-lux-onerepublic-v1.png", status: "illustrated" },
    { id: "lux-toro-oyster", city: "Luxembourg", title: "Toro 与生蚝", text: "好吃好吃好吃香香", tags: ["rare", "friends"], art: "assets/generated/postcard-lux-toro-oyster-v1.png", status: "illustrated" },
    ...
    { id: "nancy-animal-space", city: "Nancy", title: "公园里的动物朋友", text: "每次见到小动物就会哈特软软", tags: ["friends", "sunny"], art: "assets/generated/postcard-nancy-animals-v1.png", status: "illustrated" },
    { id: "nancy-fine-arts", city: "Nancy", title: "美术馆里的慢时间", text: "非常美丽的美术馆，法国佬品味真不错", tags: ["nostalgia", "old-town"], art: "assets/generated/postcard-nancy-fine-arts-v2.png", status: "illustrated" },
    { id: "nancy-amorino", city: "Nancy", title: "花瓣冰淇淋", text: "Amorino 把冰淇淋做成花，pistachio味道的有点咸", tags: ["sunny", "celebration"], art: "assets/generated/postcard-nancy-amorino-v1.png", status: "illustrated" },
    ...
    { id: "trier-marx", city: "Trier", title: "马克思故居", text: "在马斯克上市之际去看望马克思", tags: ["old-town", "surprise"], art: "assets/generated/postcard-trier-marx-v1.png", status: "illustrated" },
    { id: "trier-palastgarten", city: "Trier", title: "Palastgarten", text: "德国的宫殿花园有点土", tags: ["sunny", "conversation"], art: "assets/generated/postcard-trier-palastgarten-v1.png", status: "illustrated" },

    { id: "ams-vintage", city: "Amsterdam", title: "Vintage 寻宝", text: "stellla在阿姆度过了花花绿绿的一日！融入当地ootd", tags: ["city", "surprise"], art: "assets/generated/postcard-ams-vintage-v1.png", status: "illustrated" },
    ...
    { id: "ams-vangogh", city: "Amsterdam", title: "梵高博物馆", text: "画在我儿时素描本上青蓝色天空里的杏花，又见面了", tags: ["nostalgia", "rare"], art: "assets/generated/postcard-ams-vangogh-v3.png", status: "illustrated" },
    { id: "ams-herring", city: "Amsterdam", title: "一起吃生鲱鱼", text: "我也要吃这种东西吗？？！！", tags: ["friends", "surprise"], art: "assets/generated/postcard-ams-herring-v1.png", status: "illustrated" },
    { id: "ams-red-light", city: "Amsterdam", title: "红灯区的夜", text: "什么时候能看到男人在橱窗里呢", tags: ["night", "city"], art: "assets/generated/postcard-ams-red-light-v1.png", status: "illustrated" },
    { id: "ams-allnight-talk", city: "Amsterdam", title: "通宵畅聊", text: "有些旅行真正记住的不是地点，是一场不舍得结束的谈话。", tags: ["night", "conversation", "rare"], art: "assets/generated/postcard-ams-allnight-talk-v1.png", status: "illustrated" },
    { id: "ams-bottle-return", city: "Amsterdam", title: "回收空瓶支线", text: "韩老师教我财富密码", tags: ["city", "surprise"], art: "assets/generated/postcard-ams-bottle-return-v1.png", status: "illustrated" },
    { id: "ams-han-studio", city: "Amsterdam", title: "热得睡不着的 Studio", text: "韩老师的可爱小家，但是为什么我洗完澡就开始出汗", tags: ["home", "friends", "conversation"], art: "assets/generated/postcard-ams-han-studio-v1.png", status: "illustrated", private: true },
    { id: "ams-flower-market", city: "Amsterdam", title: "花卉市场", text: "诶我怎么两手空空地离开了", tags: ["water", "sunny"], art: "assets/generated/postcard-ams-flower-market-v1.png", status: "illustrated" }
  ]
};
